...
public class DirChooserDialog extends Dialog implements android.view.View.OnClickListener
{
    ...
    public String DecideMusic=new String();
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		 ...
		 * et.setWidth(240); et.setHeight(70); et.setGravity(Gravity.CENTER);
		 * et.setPadding(0, 2, 0, 0); titleView.addView(et);
		 * et.setText("FileName"); }
		 */
	...
	private OnItemClickListener lvLis = new OnItemClickListener()
	{
		...
		/*	if (temp.equals(".."))
            ...
            for (int i=0;i<fileType.length;i++){
                if (temp.contains("."+fileType[i])){
                    notification.sound= Uri.parse("file://"+path+"/"+temp);
                    Log.d("DirMusic","file://"+path+"/"+temp);
                    notificationManager.notify(201380977, notification);
                    DecideMusic=temp;
                    return;
                }
            }
...
//			dismiss();
	...
	public void onClick(View v)
	{
        ...
        if (v.getId() == ok.getId())
		{
            ...
            dismiss();
			// if (type == TypeSave)
			// path = path + "/";// + et.getEditableText().toString();
			Toast.makeText(context, path, Toast.LENGTH_SHORT).show();
		}
